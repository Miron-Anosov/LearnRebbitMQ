...
def consume_messages(
    ...
    queue_ = channel.queue_declare(
        ...
        auto_delete=True, # Указывает, что очередь должна быть автоматически удалена, когда все её потребители отключатся.
        exclusive=True, # Указывает, что очередь привязана только к текущему соединению и будет автоматически удалена при закрытии этого соединения.
